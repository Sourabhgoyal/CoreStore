...
public class Utilities {
    ...
    public static String[] listToStringArray(List<String> anyList) {
        try {
            ...
            Utilities.write("ErrorLog", "Encountered error in utilities list to string array list." + ex.getMessage());
            return null;
        }
    ...
    public static Boolean write(String fname, String fcontent) {
        try {
            ...
            Utilities.write("ErrorLog", "Encountered error in utilities writing fname,fcontent " + e.getMessage());
            return false;
        }
    }
    ...
    public static void saveToFile(Context context, String className, Object object) {
        try {
            ...
            Utilities.write("ErrorLog", "Encountered error in utilities save to file." + e.getMessage());
        }
    }
    ...
    public static Object readFromFile(Context context, String className) {
        ...
        try {
            ...
            Utilities.write("ErrorLog", "Encountered error in utilities reading from file." + e.getMessage());
            return null;
    ...
    public static void writeToSharedPref(Context context, String key, String value) {
        SharedPreferences data = context.getSharedPreferences("cashSavvy", 0);
    ...
    public static String readFromSharedPref(Context context, String key) {
        try {
            SharedPreferences somedata = context.getSharedPreferences("cashSavvy", 0);
            String data = somedata.getString(key, "");
            return data;
        } catch (Exception ex) {
            Utilities.write("ErrorLog", "Encountered error in utilities reading from shared Prefrences." + ex.getMessage());
            return null;
        }
    }
    ...
    public static ArrayList<String> read(String fname, Boolean checkReference) {
        ...
        try {
            ...
            Utilities.write("ErrorLog", "Encountered error in utilities reading file." + e.getMessage());
            return null;
    ...
    public static void deleteFile(String fname) {
        try {
            ...
            Utilities.write("ErrorLog", "Encountered error in utilities deleting file." + ex.getMessage());
        }
    }
    ...
    public String listToQueryList(ArrayList<String> anyList) {
        try {
            ...
            Utilities.write("ErrorLog", "Encountered error in utilities list to query list." + ex.getMessage());
            return null;
        }
    }
}
